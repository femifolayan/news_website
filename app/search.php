...
<div class="row wrapper border-bottom white-bg page-heading">
        ...
        if ($_POST) {
            ...
            $sql = "SELECT * FROM `news` WHERE uin LIKE '%" . $search . "%' OR user LIKE '%" . $search . "%' OR category LIKE '%" . $search . "%' ORDER by uin";
        ...
        ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a <?php echo "href='update.php?id=" . $row['id'] . "' title='Update News'"; ?> onclick="return confirm('EDIT NEWS?');">Edit</a></li>
                                            <li><a <?php echo "href='delete.php?id=" . $row['id'] . "' title='Delete News'"; ?> onclick="return confirm('DELETE NEWS?'); ">Delete</a></li>
                                        </ul>
                                    </div></td>
                                            </tr>
                                            <?php  

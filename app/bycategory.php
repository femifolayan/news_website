...
<div class="row wrapper border-bottom white-bg page-heading">
        ...
        if ($_POST) {
            ...
            $sql = "SELECT * FROM `news` WHERE category = '$category' AND date BETWEEN '$datefrom' AND '$dateto' ORDER by uin";
        ...
        ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a <?php echo "href='view_news.php?id=" . $row['id'] . "' title='News by Category'"; ?>>View</a></li>

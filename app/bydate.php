...
<div class="row wrapper border-bottom white-bg page-heading">
        ...
        if ($_POST) {
            ...
            $sql = "SELECT * FROM `news` WHERE date BETWEEN '$datefrom' AND '$dateto' ORDER by uin";
            // $sql = "SELECT * FROM `news` WHERE date BETWEEN '$datefrom' AND '$dateto' ORDER by uin DESC LIMIT 0, 5";
            // $sql = "SELECT * FROM `news` WHERE date BETWEEN '$datefrom' AND '$dateto' ORDER by uin ASC LIMIT 0, 5";
        ...
        ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a <?php echo "href='view_news.php?id=" . $row['id'] . "' title='News by date'"; ?>>View</a></li>
